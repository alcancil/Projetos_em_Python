...
# aqui o comando lê linha a linha os comando contidos dentro do arquivo cli.txt
with open("cli.txt") as f:
    ...
    for cada_ip in devyces:
         for comand in comandos:
             ...
             # envia uma lista de comando contidos no arquivo cli.txt
             # se quisessemos enviar um unico arquivo usariamos assim: net_connect.send_command(comando)
             output = net_connect.send_config_set(comand)
